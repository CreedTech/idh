function App() {
  return (
    <div className="max-w-screen-xl mx-auto px-16">
      <div className="w-full p-20 bg-[#C43B80] text-white ">
        <h1 className="text-5xl mb-6">What is IDA?</h1>
        <p>
      ...
      <div>
        ...
        <form method="POST" action="https://formsubmit.co/henigancarolyn@gmail.com">
